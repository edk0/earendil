...
class MessageHandler:
    def on_passwd(self, passwd: Passwd) -> None: pass
    def on_nick(self, nick: Nick) -> None: pass
    def on_user(self, user: User) -> None: pass
    def on_oper(self, oper: Oper) -> None: pass
    def on_mode(self, mode: Mode) -> None: pass
    def on_service(self, service: Service) -> None: pass
    def on_quit(self, quit: Quit) -> None: pass
    def on_s_quit(self, s_quit: SQuit) -> None: pass
    def on_channel_join(self, channel_join: ChannelJoin) -> None: pass
    def on_channel_part(self, channel_part: ChannelPart) -> None: pass
    def on_topic(self, topic: Topic) -> None: pass
    def on_names(self, names: Names) -> None: pass
    def on_list(self, list: List) -> None: pass
    def on_invite(self, invite: Invite) -> None: pass
    def on_kick(self, kick: Kick) -> None: pass
    def on_privmsg(self, privmsg: Privmsg) -> None: pass
    def on_notice(self, notice: Notice) -> None: pass
    def on_motd(self, motd: Motd) -> None: pass
    def on_lusers(self, lusers: Lusers) -> None: pass
    def on_version(self, version: Version) -> None: pass
    def on_stats(self, stats: Stats) -> None: pass
    def on_links(self, links: Links) -> None: pass
    def on_time(self, time: Time) -> None: pass
    def on_server_connect(self, server_connect: ServerConnect) -> None: pass
    def on_trace(self, trace: Trace) -> None: pass
    def on_admin(self, admin: Admin) -> None: pass
    def on_info(self, info: Info) -> None: pass
    def on_serv_list(self, serv_list: ServList) -> None: pass
    def on_s_query(self, s_query: SQuery) -> None: pass
    def on_who(self, who: Who) -> None: pass
    def on_who_is(self, who_is: WhoIs) -> None: pass
    def on_who_was(self, who_was: WhoWas) -> None: pass
    def on_kill(self, kill: Kill) -> None: pass
    def on_ping(self, ping: Ping) -> None: pass
    def on_pong(self, pong: Pong) -> None: pass
    def on_error(self, error: Error) -> None: pass
    def on_away(self, away: Away) -> None: pass
    def on_rehash(self, rehash: Rehash) -> None: pass
    def on_die(self, die: Die) -> None: pass
    def on_restart(self, restart: Restart) -> None: pass
    def on_summon(self, summon: Summon) -> None: pass
    def on_users(self, users: Users) -> None: pass
    def on_wall_ops(self, wall_ops: WallOps) -> None: pass
    def on_user_host(self, user_host: UserHost) -> None: pass
    def on_is_on(self, is_on: IsOn) -> None: pass
    def on_welcome(self, welcome: Welcome) -> None: pass
    def on_your_host(self, your_host: YourHost) -> None: pass
    def on_created(self, created: Created) -> None: pass
    def on_my_info(self, my_info: MyInfo) -> None: pass
    def on_bounce(self, bounce: Bounce) -> None: pass
    def on_trace_link_reply(self, trace_link_reply: TraceLinkReply) -> None: pass
    def on_trace_connecting(self, trace_connecting: TraceConnecting) -> None: pass
    def on_trace_handshake(self, trace_handshake: TraceHandshake) -> None: pass
    def on_trace_unknown(self, trace_unknown: TraceUnknown) -> None: pass
    def on_trace_operator(self, trace_operator: TraceOperator) -> None: pass
    def on_trace_user(self, trace_user: TraceUser) -> None: pass
    def on_trace_server(self, trace_server: TraceServer) -> None: pass
    def on_trace_service(self, trace_service: TraceService) -> None: pass
    def on_trace_newtype(self, trace_newtype: TraceNewtype) -> None: pass
    def on_trace_class(self, trace_class: TraceClass) -> None: pass
    def on_stats_link_info(self, stats_link_info: StatsLinkInfo) -> None: pass
    def on_stats_commands(self, stats_commands: StatsCommands) -> None: pass
    def on_stats_end(self, stats_end: StatsEnd) -> None: pass
    def on_user_mode_is(self, user_mode_is: UserModeIs) -> None: pass
    def on_serv_list_reply(self, serv_list_reply: ServListReply) -> None: pass
    def on_serv_list_end(self, serv_list_end: ServListEnd) -> None: pass
    def on_stats_uptime(self, stats_uptime: StatsUptime) -> None: pass
    def on_stats_oline(self, stats_oline: StatsOline) -> None: pass
    def on_luser_client(self, luser_client: LuserClient) -> None: pass
    def on_luser_op(self, luser_op: LuserOp) -> None: pass
    def on_luser_unknown(self, luser_unknown: LuserUnknown) -> None: pass
    def on_luser_channels(self, luser_channels: LuserChannels) -> None: pass
    def on_luser_me(self, luser_me: LuserMe) -> None: pass
    def on_admin_me(self, admin_me: AdminMe) -> None: pass
    def on_admin_loc1(self, admin_loc1: AdminLoc1) -> None: pass
    def on_admin_loc2(self, admin_loc2: AdminLoc2) -> None: pass
    def on_admin_email(self, admin_email: AdminEmail) -> None: pass
    def on_trace_log(self, trace_log: TraceLog) -> None: pass
    def on_trace_end(self, trace_end: TraceEnd) -> None: pass
    def on_try_again(self, try_again: TryAgain) -> None: pass
    def on_away_reply(self, away_reply: AwayReply) -> None: pass
    def on_user_host_reply(self, user_host_reply: UserHostReply) -> None: pass
    def on_is_on_reply(self, is_on_reply: IsOnReply) -> None: pass
    def on_unaway_reply(self, unaway_reply: UnawayReply) -> None: pass
    def on_now_away_reply(self, now_away_reply: NowAwayReply) -> None: pass
    def on_who_is_user(self, who_is_user: WhoIsUser) -> None: pass
    def on_who_is_server(self, who_is_server: WhoIsServer) -> None: pass
    def on_who_is_operator(self, who_is_operator: WhoIsOperator) -> None: pass
    def on_who_was_user(self, who_was_user: WhoWasUser) -> None: pass
    def on_who_end(self, who_end: WhoEnd) -> None: pass
    def on_who_is_idle(self, who_is_idle: WhoIsIdle) -> None: pass
    def on_who_is_end(self, who_is_end: WhoIsEnd) -> None: pass
    def on_who_is_channels(self, who_is_channels: WhoIsChannels) -> None: pass
    def on_list_reply(self, list_reply: ListReply) -> None: pass
    def on_list_end(self, list_end: ListEnd) -> None: pass
    def on_channel_mode_is(self, channel_mode_is: ChannelModeIs) -> None: pass
    def on_uniq_op_is(self, uniq_op_is: UniqOpIs) -> None: pass
    def on_no_topic_reply(self, no_topic_reply: NoTopicReply) -> None: pass
    def on_topic_reply(self, topic_reply: TopicReply) -> None: pass
    def on_inviting(self, inviting: Inviting) -> None: pass
    def on_summoning(self, summoning: Summoning) -> None: pass
    def on_invite_list(self, invite_list: InviteList) -> None: pass
    def on_invite_list_end(self, invite_list_end: InviteListEnd) -> None: pass
    def on_except_list(self, except_list: ExceptList) -> None: pass
    def on_except_list_end(self, except_list_end: ExceptListEnd) -> None: pass
    def on_version_reply(self, version_reply: VersionReply) -> None: pass
    def on_who_reply(self, who_reply: WhoReply) -> None: pass
    def on_names_reply(self, names_reply: NamesReply) -> None: pass
    def on_links_reply(self, links_reply: LinksReply) -> None: pass
    def on_links_end(self, links_end: LinksEnd) -> None: pass
    def on_names_end(self, names_end: NamesEnd) -> None: pass
    def on_ban_list(self, ban_list: BanList) -> None: pass
    def on_ban_list_end(self, ban_list_end: BanListEnd) -> None: pass
    def on_who_was_end(self, who_was_end: WhoWasEnd) -> None: pass
    def on_info_reply(self, info_reply: InfoReply) -> None: pass
    def on_motd_text(self, motd_text: MotdText) -> None: pass
    def on_info_end(self, info_end: InfoEnd) -> None: pass
    def on_motd_start(self, motd_start: MotdStart) -> None: pass
    def on_motd_end(self, motd_end: MotdEnd) -> None: pass
    def on_youre_oper(self, youre_oper: YoureOper) -> None: pass
    def on_rehashing(self, rehashing: Rehashing) -> None: pass
    def on_youre_service(self, youre_service: YoureService) -> None: pass
    def on_time_reply(self, time_reply: TimeReply) -> None: pass
    def on_users_start(self, users_start: UsersStart) -> None: pass
    def on_users_reply(self, users_reply: UsersReply) -> None: pass
    def on_users_end(self, users_end: UsersEnd) -> None: pass
    def on_no_users(self, no_users: NoUsers) -> None: pass
    def on_no_such_nick(self, no_such_nick: NoSuchNick) -> None: pass
    def on_no_such_server(self, no_such_server: NoSuchServer) -> None: pass
    def on_no_such_channel(self, no_such_channel: NoSuchChannel) -> None: pass
    def on_cant_send_to_chan(self, cant_send_to_chan: CantSendToChan) -> None: pass
    def on_too_many_channels(self, too_many_channels: TooManyChannels) -> None: pass
    def on_was_no_such_nick(self, was_no_such_nick: WasNoSuchNick) -> None: pass
    def on_too_many_targets(self, too_many_targets: TooManyTargets) -> None: pass
    def on_no_such_service(self, no_such_service: NoSuchService) -> None: pass
    def on_no_origin(self, no_origin: NoOrigin) -> None: pass
    def on_no_recipient(self, no_recipient: NoRecipient) -> None: pass
    def on_no_text_to_send(self, no_text_to_send: NoTextToSend) -> None: pass
    def on_no_top_level(self, no_top_level: NoTopLevel) -> None: pass
    def on_wild_top_level(self, wild_top_level: WildTopLevel) -> None: pass
    def on_bad_mask(self, bad_mask: BadMask) -> None: pass
    def on_unknown_command(self, unknown_command: UnknownCommand) -> None: pass
    def on_no_motd(self, no_motd: NoMotd) -> None: pass
    def on_no_admin_info(self, no_admin_info: NoAdminInfo) -> None: pass
    def on_file_error(self, file_error: FileError) -> None: pass
    def on_no_nickname_given(self, no_nickname_given: NoNicknameGiven) -> None: pass
    def on_erroneus_nickname(self, erroneus_nickname: ErroneusNickname) -> None: pass
    def on_nickname_in_use(self, nickname_in_use: NicknameInUse) -> None: pass
    def on_nick_collision(self, nick_collision: NickCollision) -> None: pass
    def on_unavail_resource(self, unavail_resource: UnavailResource) -> None: pass
    def on_user_not_in_channel(self, user_not_in_channel: UserNotInChannel) -> None: pass
    def on_not_on_channel(self, not_on_channel: NotOnChannel) -> None: pass
    def on_user_on_channel(self, user_on_channel: UserOnChannel) -> None: pass
    def on_no_login(self, no_login: NoLogin) -> None: pass
    def on_summon_disabled(self, summon_disabled: SummonDisabled) -> None: pass
    def on_users_disabled(self, users_disabled: UsersDisabled) -> None: pass
    def on_not_registered(self, not_registered: NotRegistered) -> None: pass
    def on_need_more_params(self, need_more_params: NeedMoreParams) -> None: pass
    def on_already_registered(self, already_registered: AlreadyRegistered) -> None: pass
    def on_no_perm_for_host(self, no_perm_for_host: NoPermForHost) -> None: pass
    def on_password_mismatch(self, password_mismatch: PasswordMismatch) -> None: pass
    def on_youre_banned_creep(self, youre_banned_creep: YoureBannedCreep) -> None: pass
    def on_you_will_be_banned(self, you_will_be_banned: YouWillBeBanned) -> None: pass
    def on_key_set(self, key_set: KeySet) -> None: pass
    def on_channel_is_full(self, channel_is_full: ChannelIsFull) -> None: pass
    def on_unknown_mode(self, unknown_mode: UnknownMode) -> None: pass
    def on_invite_only_chan(self, invite_only_chan: InviteOnlyChan) -> None: pass
    def on_banned_from_chan(self, banned_from_chan: BannedFromChan) -> None: pass
    def on_bad_channel_key(self, bad_channel_key: BadChannelKey) -> None: pass
    def on_bad_chan_mask(self, bad_chan_mask: BadChanMask) -> None: pass
    def on_no_chan_modes(self, no_chan_modes: NoChanModes) -> None: pass
    def on_ban_list_full(self, ban_list_full: BanListFull) -> None: pass
    def on_no_privileges(self, no_privileges: NoPrivileges) -> None: pass
    def on_chan_op_privs_needed(self, chan_op_privs_needed: ChanOpPrivsNeeded) -> None: pass
    def on_cant_kill_server(self, cant_kill_server: CantKillServer) -> None: pass
    def on_restricted(self, restricted: Restricted) -> None: pass
    def on_uniq_op_privs_needed(self, uniq_op_privs_needed: UniqOpPrivsNeeded) -> None: pass
    def on_no_oper_host(self, no_oper_host: NoOperHost) -> None: pass
    def on_user_mode_unknown_flag(self, user_mode_unknown_flag: UserModeUnknownFlag) -> None: pass
    def on_users_dont_match(self, users_dont_match: UsersDontMatch) -> None: pass
    def on_message(self, msg: Message) -> None:
        if isinstance(msg, Passwd):
            self.on_passwd(msg)
        elif isinstance(msg, Nick):
            self.on_nick(msg)
        elif isinstance(msg, User):
            self.on_user(msg)
        elif isinstance(msg, Oper):
            self.on_oper(msg)
        elif isinstance(msg, Mode):
            self.on_mode(msg)
        elif isinstance(msg, Service):
            self.on_service(msg)
        elif isinstance(msg, Quit):
            self.on_quit(msg)
        elif isinstance(msg, SQuit):
            self.on_s_quit(msg)
        elif isinstance(msg, ChannelJoin):
            self.on_channel_join(msg)
        elif isinstance(msg, ChannelPart):
            self.on_channel_part(msg)
        elif isinstance(msg, Topic):
            self.on_topic(msg)
        elif isinstance(msg, Names):
            self.on_names(msg)
        elif isinstance(msg, List):
            self.on_list(msg)
        elif isinstance(msg, Invite):
            self.on_invite(msg)
        elif isinstance(msg, Kick):
            self.on_kick(msg)
        elif isinstance(msg, Privmsg):
            self.on_privmsg(msg)
        elif isinstance(msg, Notice):
            self.on_notice(msg)
        elif isinstance(msg, Motd):
            self.on_motd(msg)
        elif isinstance(msg, Lusers):
            self.on_lusers(msg)
        elif isinstance(msg, Version):
            self.on_version(msg)
        elif isinstance(msg, Stats):
            self.on_stats(msg)
        elif isinstance(msg, Links):
            self.on_links(msg)
        elif isinstance(msg, Time):
            self.on_time(msg)
        elif isinstance(msg, ServerConnect):
            self.on_server_connect(msg)
        elif isinstance(msg, Trace):
            self.on_trace(msg)
        elif isinstance(msg, Admin):
            self.on_admin(msg)
        elif isinstance(msg, Info):
            self.on_info(msg)
        elif isinstance(msg, ServList):
            self.on_serv_list(msg)
        elif isinstance(msg, SQuery):
            self.on_s_query(msg)
        elif isinstance(msg, Who):
            self.on_who(msg)
        elif isinstance(msg, WhoIs):
            self.on_who_is(msg)
        elif isinstance(msg, WhoWas):
            self.on_who_was(msg)
        elif isinstance(msg, Kill):
            self.on_kill(msg)
            ...
            self.on_error(msg)
        elif isinstance(msg, Away):
            self.on_away(msg)
        elif isinstance(msg, Rehash):
            self.on_rehash(msg)
        elif isinstance(msg, Die):
            self.on_die(msg)
        elif isinstance(msg, Restart):
            self.on_restart(msg)
        elif isinstance(msg, Summon):
            self.on_summon(msg)
        elif isinstance(msg, Users):
            self.on_users(msg)
        elif isinstance(msg, WallOps):
            self.on_wall_ops(msg)
        elif isinstance(msg, UserHost):
            self.on_user_host(msg)
        elif isinstance(msg, IsOn):
            self.on_is_on(msg)
        elif isinstance(msg, Welcome):
            self.on_welcome(msg)
        elif isinstance(msg, YourHost):
            self.on_your_host(msg)
        elif isinstance(msg, Created):
            self.on_created(msg)
        elif isinstance(msg, MyInfo):
            self.on_my_info(msg)
        elif isinstance(msg, Bounce):
            self.on_bounce(msg)
        elif isinstance(msg, TraceLinkReply):
            self.on_trace_link_reply(msg)
        elif isinstance(msg, TraceConnecting):
            self.on_trace_connecting(msg)
        elif isinstance(msg, TraceHandshake):
            self.on_trace_handshake(msg)
        elif isinstance(msg, TraceUnknown):
            self.on_trace_unknown(msg)
        elif isinstance(msg, TraceOperator):
            self.on_trace_operator(msg)
        elif isinstance(msg, TraceUser):
            self.on_trace_user(msg)
        elif isinstance(msg, TraceServer):
            self.on_trace_server(msg)
        elif isinstance(msg, TraceService):
            self.on_trace_service(msg)
        elif isinstance(msg, TraceNewtype):
            self.on_trace_newtype(msg)
        elif isinstance(msg, TraceClass):
            self.on_trace_class(msg)
        elif isinstance(msg, StatsLinkInfo):
            self.on_stats_link_info(msg)
        elif isinstance(msg, StatsCommands):
            self.on_stats_commands(msg)
        elif isinstance(msg, StatsEnd):
            self.on_stats_end(msg)
        elif isinstance(msg, UserModeIs):
            self.on_user_mode_is(msg)
        elif isinstance(msg, ServListReply):
            self.on_serv_list_reply(msg)
        elif isinstance(msg, ServListEnd):
            self.on_serv_list_end(msg)
        elif isinstance(msg, StatsUptime):
            self.on_stats_uptime(msg)
        elif isinstance(msg, StatsOline):
            self.on_stats_oline(msg)
        elif isinstance(msg, LuserClient):
            self.on_luser_client(msg)
        elif isinstance(msg, LuserOp):
            self.on_luser_op(msg)
        elif isinstance(msg, LuserUnknown):
            self.on_luser_unknown(msg)
        elif isinstance(msg, LuserChannels):
            self.on_luser_channels(msg)
        elif isinstance(msg, LuserMe):
            self.on_luser_me(msg)
        elif isinstance(msg, AdminMe):
            self.on_admin_me(msg)
        elif isinstance(msg, AdminLoc1):
            self.on_admin_loc1(msg)
        elif isinstance(msg, AdminLoc2):
            self.on_admin_loc2(msg)
        elif isinstance(msg, AdminEmail):
            self.on_admin_email(msg)
        elif isinstance(msg, TraceLog):
            self.on_trace_log(msg)
        elif isinstance(msg, TraceEnd):
            self.on_trace_end(msg)
        elif isinstance(msg, TryAgain):
            self.on_try_again(msg)
        elif isinstance(msg, AwayReply):
            self.on_away_reply(msg)
        elif isinstance(msg, UserHostReply):
            self.on_user_host_reply(msg)
        elif isinstance(msg, IsOnReply):
            self.on_is_on_reply(msg)
        elif isinstance(msg, UnawayReply):
            self.on_unaway_reply(msg)
        elif isinstance(msg, NowAwayReply):
            self.on_now_away_reply(msg)
        elif isinstance(msg, WhoIsUser):
            self.on_who_is_user(msg)
        elif isinstance(msg, WhoIsServer):
            self.on_who_is_server(msg)
        elif isinstance(msg, WhoIsOperator):
            self.on_who_is_operator(msg)
        elif isinstance(msg, WhoWasUser):
            self.on_who_was_user(msg)
        elif isinstance(msg, WhoEnd):
            self.on_who_end(msg)
        elif isinstance(msg, WhoIsIdle):
            self.on_who_is_idle(msg)
        elif isinstance(msg, WhoIsEnd):
            self.on_who_is_end(msg)
        elif isinstance(msg, WhoIsChannels):
            self.on_who_is_channels(msg)
        elif isinstance(msg, ListReply):
            self.on_list_reply(msg)
        elif isinstance(msg, ListEnd):
            self.on_list_end(msg)
        elif isinstance(msg, ChannelModeIs):
            self.on_channel_mode_is(msg)
        elif isinstance(msg, UniqOpIs):
            self.on_uniq_op_is(msg)
        elif isinstance(msg, NoTopicReply):
            self.on_no_topic_reply(msg)
        elif isinstance(msg, TopicReply):
            self.on_topic_reply(msg)
        elif isinstance(msg, Inviting):
            self.on_inviting(msg)
        elif isinstance(msg, Summoning):
            self.on_summoning(msg)
        elif isinstance(msg, InviteList):
            self.on_invite_list(msg)
        elif isinstance(msg, InviteListEnd):
            self.on_invite_list_end(msg)
        elif isinstance(msg, ExceptList):
            self.on_except_list(msg)
        elif isinstance(msg, ExceptListEnd):
            self.on_except_list_end(msg)
        elif isinstance(msg, VersionReply):
            self.on_version_reply(msg)
        elif isinstance(msg, WhoReply):
            self.on_who_reply(msg)
        elif isinstance(msg, NamesReply):
            self.on_names_reply(msg)
        elif isinstance(msg, LinksReply):
            self.on_links_reply(msg)
        elif isinstance(msg, LinksEnd):
            self.on_links_end(msg)
        elif isinstance(msg, NamesEnd):
            self.on_names_end(msg)
        elif isinstance(msg, BanList):
            self.on_ban_list(msg)
        elif isinstance(msg, BanListEnd):
            self.on_ban_list_end(msg)
        elif isinstance(msg, WhoWasEnd):
            self.on_who_was_end(msg)
        elif isinstance(msg, InfoReply):
            self.on_info_reply(msg)
        elif isinstance(msg, MotdText):
            self.on_motd_text(msg)
        elif isinstance(msg, InfoEnd):
            self.on_info_end(msg)
        elif isinstance(msg, MotdStart):
            self.on_motd_start(msg)
        elif isinstance(msg, MotdEnd):
            self.on_motd_end(msg)
        elif isinstance(msg, YoureOper):
            self.on_youre_oper(msg)
        elif isinstance(msg, Rehashing):
            self.on_rehashing(msg)
        elif isinstance(msg, YoureService):
            self.on_youre_service(msg)
        elif isinstance(msg, TimeReply):
            self.on_time_reply(msg)
        elif isinstance(msg, UsersStart):
            self.on_users_start(msg)
        elif isinstance(msg, UsersReply):
            self.on_users_reply(msg)
        elif isinstance(msg, UsersEnd):
            self.on_users_end(msg)
        elif isinstance(msg, NoUsers):
            self.on_no_users(msg)
        elif isinstance(msg, NoSuchNick):
            self.on_no_such_nick(msg)
        elif isinstance(msg, NoSuchServer):
            self.on_no_such_server(msg)
        elif isinstance(msg, NoSuchChannel):
            self.on_no_such_channel(msg)
        elif isinstance(msg, CantSendToChan):
            self.on_cant_send_to_chan(msg)
        elif isinstance(msg, TooManyChannels):
            self.on_too_many_channels(msg)
        elif isinstance(msg, WasNoSuchNick):
            self.on_was_no_such_nick(msg)
        elif isinstance(msg, TooManyTargets):
            self.on_too_many_targets(msg)
        elif isinstance(msg, NoSuchService):
            self.on_no_such_service(msg)
        elif isinstance(msg, NoOrigin):
            self.on_no_origin(msg)
        elif isinstance(msg, NoRecipient):
            self.on_no_recipient(msg)
        elif isinstance(msg, NoTextToSend):
            self.on_no_text_to_send(msg)
        elif isinstance(msg, NoTopLevel):
            self.on_no_top_level(msg)
        elif isinstance(msg, WildTopLevel):
            self.on_wild_top_level(msg)
        elif isinstance(msg, BadMask):
            self.on_bad_mask(msg)
        elif isinstance(msg, UnknownCommand):
            self.on_unknown_command(msg)
        elif isinstance(msg, NoMotd):
            self.on_no_motd(msg)
        elif isinstance(msg, NoAdminInfo):
            self.on_no_admin_info(msg)
        elif isinstance(msg, FileError):
            self.on_file_error(msg)
        elif isinstance(msg, NoNicknameGiven):
            self.on_no_nickname_given(msg)
        elif isinstance(msg, ErroneusNickname):
            self.on_erroneus_nickname(msg)
        elif isinstance(msg, NicknameInUse):
            self.on_nickname_in_use(msg)
        elif isinstance(msg, NickCollision):
            self.on_nick_collision(msg)
        elif isinstance(msg, UnavailResource):
            self.on_unavail_resource(msg)
        elif isinstance(msg, UserNotInChannel):
            self.on_user_not_in_channel(msg)
        elif isinstance(msg, NotOnChannel):
            self.on_not_on_channel(msg)
        elif isinstance(msg, UserOnChannel):
            self.on_user_on_channel(msg)
        elif isinstance(msg, NoLogin):
            self.on_no_login(msg)
        elif isinstance(msg, SummonDisabled):
            self.on_summon_disabled(msg)
        elif isinstance(msg, UsersDisabled):
            self.on_users_disabled(msg)
        elif isinstance(msg, NotRegistered):
            self.on_not_registered(msg)
        elif isinstance(msg, NeedMoreParams):
            self.on_need_more_params(msg)
        elif isinstance(msg, AlreadyRegistered):
            self.on_already_registered(msg)
        elif isinstance(msg, NoPermForHost):
            self.on_no_perm_for_host(msg)
        elif isinstance(msg, PasswordMismatch):
            self.on_password_mismatch(msg)
        elif isinstance(msg, YoureBannedCreep):
            self.on_youre_banned_creep(msg)
        elif isinstance(msg, YouWillBeBanned):
            self.on_you_will_be_banned(msg)
        elif isinstance(msg, KeySet):
            self.on_key_set(msg)
        elif isinstance(msg, ChannelIsFull):
            self.on_channel_is_full(msg)
        elif isinstance(msg, UnknownMode):
            self.on_unknown_mode(msg)
        elif isinstance(msg, InviteOnlyChan):
            self.on_invite_only_chan(msg)
        elif isinstance(msg, BannedFromChan):
            self.on_banned_from_chan(msg)
        elif isinstance(msg, BadChannelKey):
            self.on_bad_channel_key(msg)
        elif isinstance(msg, BadChanMask):
            self.on_bad_chan_mask(msg)
        elif isinstance(msg, NoChanModes):
            self.on_no_chan_modes(msg)
        elif isinstance(msg, BanListFull):
            self.on_ban_list_full(msg)
        elif isinstance(msg, NoPrivileges):
            self.on_no_privileges(msg)
        elif isinstance(msg, ChanOpPrivsNeeded):
            self.on_chan_op_privs_needed(msg)
        elif isinstance(msg, CantKillServer):
            self.on_cant_kill_server(msg)
        elif isinstance(msg, Restricted):
            self.on_restricted(msg)
        elif isinstance(msg, UniqOpPrivsNeeded):
            self.on_uniq_op_privs_needed(msg)
        elif isinstance(msg, NoOperHost):
            self.on_no_oper_host(msg)
        elif isinstance(msg, UserModeUnknownFlag):
            self.on_user_mode_unknown_flag(msg)
        elif isinstance(msg, UsersDontMatch):
            self.on_users_dont_match(msg)
